                                ...
                                },
                                {
                                    ...
                                    column: [
                                        ...
                                        },
                                        {
                                            ...
                                            padding: 20,
                                            column: [
                                                this.textBlock("First things first: No you can't download it. However, I will share with you the story behind it."),
                                                this.textBlock("Next, since I'm going to dip my toes into the territory of custom game elements: Eric, if you happen to be reading this, rest assured that I wholeheartedly adhere to"),
                                                {
                                                    text: "the terms for creating Spirit Island game elements set forth in the FAQ.",
                                                    color: "rgb(217, 220, 255)",
                                                    size: 16,
                                                    className: "link",
                                                    cursor: src_quickdom_enums_Cursor__WEBPACK_IMPORTED_MODULE_3__.Cursor.Pointer,
                                                ...
                                                this.separator,
                                                this.textBlock("With that out of the way, let's talk about how this project came to be. Upon experimenting with several digital adaptations of Spirit Island, it became evident that existing options lacked the flexibility needed to effectively showcase the intricate gameplay of Spirit Island. In particular, none of these platforms included all expansions while simultanously managed to show all game elements on a single screen. Faced with this gap, the logical solution was to embark on the journey of creating my own custom client. And embark I did."),
                                                this.extraLine,
                                                this.textBlock("The guiding principle behind this endeavor was clear: to develop a modern, simple, yet potent, uncluttered, and viewer-friendly user interface. The overarching goal was to ensure that crucial information remained effortlessly visible on the screen at all times. This article aims to shed light on the standout features and pivotal design choices that define this custom client, born out of the necessity for a more versatile and engaging Spirit Island digital experience."),
                                                this.extraLine,
                                                this.textBlock("This became the end result."),
                                                this.image("images/screens/memoryThematic.png", 1140, 641),
                                                this.separator,
                                                this.header("Customizable Game Setup"),
                                                this.textBlock("But first let's go back to the basics. The first task was to make a customizable setup where I could configure the boards, the locations of spirit but also toggle on and off all the various play modes such as an extra empty board, double adversaries and thematic boards. I settled on a simple interface where one could drag boards around and assign Spirits/Aspects."),
                                                this.image("images/screens/setup.png", 1140, 641),
                                                this.separator,
                                                this.textBlock("The logical follow-up was then to also include randomization options. I added separate options to randomize each part of the setup as well as a lets-see-what-happens button to get a complete random setup of the current difficulty. One of the more fun sub-projects was to implement the official layouts as well as a complete random generator that also included archipelagos."),
                                                this.video("videos/island.mp4", 1140, 790),
                                                this.separator,
                                                this.header("Thematic Board Overhaul"),
                                                this.textBlock("Upon assessing the thematic board, it became apparent that enhancements were essential. The existing setup limited its use to a single configuration, and the intentionally textured design, while purposeful, resulted in a somewhat cluttered appearance. Additionally, the small lands with meandering borders proved impractical when accommodating an increasing number of tokens."),
                                                this.extraLine,
                                                this.textBlock("To address these issues, I initiated several changes to refine the thematic board in comparison to its cardboard counterpart. Firstly, I modified the textures to create a clearer distinction between lands. Secondly, I made adjustments to the edge borders and coast to allow for any layout configuration, including the circular board showcased below. Lastly, I slightly straightened the inner borders to counteract the smaller land sizes, providing more space for tokens. These alterations aimed to optimize the thematic board for a more enjoyable gaming experience, and I eagerly anticipated the prospect of playing on the revamped boards."),
                                                this.image("images/screens/thematic.png", 1140, 1035),
                                                this.textBlock("After setup was taken care of came a much tougher problem to tackle..."),
                                                this.separator,
                                                this.header("Following the Rules"),
                                                this.textBlock("Initially, the client was a simple sandbox, allowing me to add and remove tokens in various lands. However, it became apparent that a significant amount of time was dedicated to ensuring rule adherence. Balancing this with the challenge of articulating something resembling intelligent commentary for my modest YouTube audience placed a considerable strain on my cognitive resources. Recognizing the need for improvement, a pivotal shift was imperative."),
                                                this.extraLine,
                                                this.textBlock("Engaging in months of meticulous work within the official FAQ (Querki) and the in-depth-rules channel of the official Discord server - harrassing the rule lawyers there with one weird corner case after another - I finally got something that started to look like rules that followed the official way of playing."),
                                                this.extraLine,
                                                this.textBlock("And so it came to be that the client now incorporates the complete ruleset of all published expansions, encompassing all spirits, aspects, scenarios, adversaries, powers, events, etc."),
                                                this.image("images/screens/sets.png", 1140, 295),
                                                this.separator,
                                                this.header("Streamlined Gameplay Clarity"),
                                                this.textBlock("When coming to actually presenting the game state I knew I had to invest effort into making everything as clear as possible. One of the greatest challenges was how to present what to do next in any given moment while simultanously present the most vital game elements such as the island boards, the invader board, the spirit boards and the power cards. What I end up with was an always visible invader board collapsed into a side bar, an always visible query box that always tell us what to do next, and then a scrollable and zoomable island taking up most of the space."),
                                                this.image("images/screens/options.png", 1140, 641),
                                                this.separator,
                                                this.header("Focused Spirit Management"),
                                                this.textBlock("The lower section of the screen was then exclusively dedicated to the selected Spirit accompanied by a designated area for its power cards. The primary goal was to focus attention on only one Spirit at a time. Trying to squeeze in multiple spirits proved counter-productive to the goal of an uncluttered interface. Additionally, this design allowed a richer, closer-to-cardboard experience with full-sized Spirit Boards and Power Cards."),
                                                this.extraLine,
                                                this.textBlock("The key to achieving this design was letting go of attempts to create different zones for played, discarded, or in-hand cards and transferring them among these zones. Instead, the approach embraced the use of symbols to denote each card's status, enhancing clarity and minimizing visual clutter. While this playing style might have felt unfamiliar initially, I soon realized its value in prominently displaying cards in discard and other zones. Having the full picture made it significantly easier to plan innate abilities and make decisions about when to reclaim or not. This design was a keeper for sure."),
                                                this.image("images/screens/cards.png", 1140, 417),
                                                this.separator,
                                                this.header("In-Game Card Catalog"),
                                                this.textBlock("After establishing the foundational elements, it became evident that crucial components were still missing. An early realization struck me when I consistently found myself navigating to a card catalog website to reference available cards. One of the problems here was that I frequently kept stumbling on the query structure and syntax, having to relearn it every now and then."),
                                                this.extraLine,
                                                this.textBlock("Frustrated by this, I decided to take matters into my own hands and implemented a personalized solution. While it may not be as sophisticated, it proved to be far more comprehensible for me. To illustrate its functionality, here's an example search of the ten fast major powers with fire elements that cost 2-4 energy."),
                                                this.image("images/screens/catalog.png", 1140, 641),
                                                this.separator,
                                                this.header("Convenient Reminders & Ongoing Effects"),
                                                this.textBlock("In the intricate landscape of Spirit Island gameplay, the multitude of simultaneous effects can pose a challenge in keeping track of every factor influencing decisions. To tackle this issue, I incorporated reminders, both global and local, for every lingering effect. Yellow reminders mark effects persisting until the end of the turn, while pink reminders mark permanent effects."),
                                                ...
                                                this.extraLine,
                                                this.textBlock("Initially faced with the dilemma of where to place the log, I eventually settled on positioning it directly below the query box while making the latter collapsible. This design choice ensured that the most critical part of the log was consistently visible at the bottom, without sacrificing valuable screen space."),
                                                this.extraLine,
                                                this.textBlock("As a finishing touch, I incorporated right-pointing arrows next to each entry, enabling me to seamlessly jump to specific points in the game's history. Additionally, certain log elements, such as cards and lands, became hoverable, providing the convenience of highlighting specific cards or lands."),
                                                this.video("videos/history.mp4", 1140, 1140),
                                                this.separator,
                                                this.header("Flexible Move Modification"),
                                                this.textBlock("As a natural consequence of enabling flexible navigation through the game's history, a new necessity gradually emerged. In the physical realm of cardboard play, it's common to desire adjustments to decisions made in earlier phases, such as subtly altering the placement of a presence for targeting purposes. In a digital context, making such changes often involves undoing multiple moves, altering the specific move, and then re-entering all subsequent moves. While this process is not too big of a problem for solo play, it becomes quite the nuisance when multiple spirits are involved, perhaps in the midst of a fast phase."),
                                                this.extraLine,
                                                this.textBlock("To address this challenge, the 'Manage Move Divergence' dialog was conceived. This feature automatically appears when a move is altered in the past. With this dialog, I gained the flexibility to effortlessly jump back to the desired point, modify the intended move, and return. Should this modification impact other moves and render them illegal, the client then protests and provides an opportunity to make additional adjustments as needed. Exploring the intricacies of this system left me pondering a question: why aren't more digital adaptations of board games incorporating similar features? In my experience, altering moves in the past is a common occurrence during board game sessions, and having a tool like this proves to be incredibly valuable."),
                                                this.image("images/screens/move_divergence.png", 507, 557),
                                                this.separator,
                                                this.header("Admin Mode Access"),
                                                this.textBlock("The aforementioned approach proved effective when ensuring the game adhered to the rules, but there were instances where I simply wanted to test scenarios, set up specific positions, or engage in experimentation – something previously was easily achievable when everything was manual. To accommodate these needs, I introduced an admin mode to override the enforced rules. Now, if I ever noticed a rule implementation error but am unwilling to backtrack and fix it, I could effortlessly invoke this mode to address the issue swiftly."),
                                                this.image("images/screens/admin_mode.png", 771, 756),
                                                this.separator,
                                                this.header("Bells and whistles"),
                                                this.textBlock("With the core functionalities in place, the final touch was to elevate the overall experience and make it more immersive. I introduced some simple animations, incorporated dynamic music that changes based on the situation, included an announcement voice for phases and invader actions, and added suitable sound effects including unique sound effects that vary from one spirit to another. The culmination of these efforts breathed life into the client, transforming it into a more dynamic and vibrant experience."),
                                                this.video("videos/flip.mp4", 1140, 500),
                                                this.separator,
                                                this.header("What about Multiplayer?"),
                                                this.textBlock("Given the cooperative nature of Spirit Island, implementing multiplayer support was a natural extension. However, the initial attempt to integrate this feature proved disastrous. The game consistently fell out of sync, and peculiar issues arose during undoing or jumping in history. To rectify this, I decided to start from scratch, ensuring that communication worked on a more solid foundation. The paramount consideration was to guarantee the stability of the game state at all times. The result of this overhaul is a system where it's now virtually impossible for clients to find themselves in a state that is out of sync."),
                                                this.extraLine,
                                                this.textBlock("Briefly entertaining the idea of adding voice communication support, I swiftly recognized that other existing services handled this aspect far more efficiently. As a result, the current multiplayer implementation is designed to be used in conjunction with an external voice chat applications, such as Discord, providing a more streamlined and effective communication experience."),
                                                this.extraLine,
                                                this.textBlock("So how did multiplayer end up working in this client? Well. Joining a game is a straightforward process—simply enter the join code found in any ongoing game. With every action performed by a player, the game state is automatically updated for all connected clients. The guiding principle in multiplayer is akin to a physical board setting, where every player can perform any action. The decision-making process is left entirely to the players, allowing them to determine who takes on which roles and in what manner. Notably, there are no enforced voting systems. To enhance the multiplayer experience, some features have been included, such as the ability to ping a specific land of interest to alert the rest of the group."),
                                                this.image("images/screens/multiplayer.png", 1140, 376),
                                                this.separator,
                                                this.header("Integrated Game Library"),
                                                this.textBlock("As my gaming sessions continued to accumulate, I found myself in need of a more organized approach. While initially having a simple system to save and load games, the concept of a game library soon took center stage. The notion of having an in-game library that cataloged every played game seemed like a fantastic idea. Subsequently, I built a dedicated page where you can not only view overall statistics but also seamlessly jump into any of the saved games. This feature proved to be an invaluable tool, especially when gearing up for the next task at hand..."),
                                                this.image("images/screens/stats.png", 1140, 606),
                                                this.separator,
                                                this.header("A.I. Capabilities"),
                                                this.textBlock("Simulating the intricacies of the rules posed one of the most formidable challenges in the development process. Most players has probably run into some situation that requires a quick lookup at Querki or posting a question to the rules section of the Discord server. But if I had known the sheer volume of potential corner cases in Spirit Island, I probably never would have tried to take upon this task. With 37 unique Spirits, each wielding special abilities that must harmonize with hundreds of other rules from adversaries, scenarios, events, and more, ensuring the functionality of every possible combination became a daunting task. For a long time, the simulation encountered issues when navigating specific situations, leading to freezes or peculiar errors that were difficult to resolve."),
                                                this.extraLine,
                                                this.textBlock("Confronted with the challenge of handling various corner cases, I recognized the need for a systematic approach. It became evident that the most efficient way to encounter and address a myriad of corner cases was through automation. Initially, I devised a random move inputter that played the game in a purely random manner. While effective to some extent, relying solely on random simulations had its limitations. Sure, these simulations could uncover some issues that could then be addressed, but the randomness didn't provide comprehensive testing, especially for situations that unfolded later in a game, as the simulations typically only lasted to turns 3 or 4 when running out of blight."),
                                                this.extraLine,
                                                this.textBlock("With the aspiration to enhance the algorithm's intelligence, I introduced a fairly simple Monte Carlo Tree Search algorithm coupled with a custom evaluation function. The results were surprisingly favorable, prompting me to delve deeper and continually refine its capabilities. The algorithm reached a notable milestone by successfully winning a difficulty 1 game. However, a significant hurdle emerged - the underlying simulation was too slow, severely limiting the number of simulations it could perform and constraining its improvement potential."),
                                                this.extraLine,
                                                this.textBlock("Undeterred, I committed months to revamping the simulation engine. Immersed in optimizing techniques at the lowest level of programming, the efforts proved fruitful. What once took seconds to simulate a complete game was now achieved in milliseconds. The result was a lightning-fast engine, significantly bolstering the algorithm's overall strength."),
                                                this.extraLine,
                                                this.textBlock("The subsequent challenge involved refining the evaluation function. I developed tools that allowed it to self-improve, tweaking values iteratively to find optimal evaluation parameters. While it hasn't reached the level of the most skilled human players, the A.I. has become sufficiently robust to win in many level 6 adversary matchups by its own. An illustrative example is showcased below, where Fathomless Mud of the Swamp emerges victorious against Sweden level 6."),
                                                this.video("videos/ai.mp4", 1140, 500),
                                                this.textBlock("Conducting thousands of automatically played games proved instrumental in addressing the initial challenge, resolving most, if not all, game-halting bugs. The sheer volume of games, each comprising hundreds of moves and simulating thousands of continuations, has led to encountering billions of game states. This extensive testing has exposed and rectified numerous peculiar situations."),
                                                this.extraLine,
